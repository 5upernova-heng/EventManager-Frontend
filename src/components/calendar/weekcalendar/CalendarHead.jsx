...
function CalendarHead() {
    ...
    const createHeaderCells = (date) => {
        ...
        return dates.map((d, index) => {
            return (
                <div
                    className="col border-start border-end py-3 d-flex flex-column align-items-center justify-content-center date-cell"
                    key={index}
                    onClick={() => setDate(dates[index])}
                >
